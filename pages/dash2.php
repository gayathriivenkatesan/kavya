...
?>
<?php
if (strpos($_SESSION['validate'], 'Success')!==false){	
...
<div class="login-container">
    ...
    <i class="fa fa-bars fa-2x toggle-btn" data-toggle="collapse" data-target="#menu-content"></i>
        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content collapse out">
				...
				<li data-toggle="collapse" data-target="#new" class="collapsed">
				 ...
				 <li data-toggle="collapse" data-target="#new" class="collapsed">
                  <a href="../AD_SER/dash5.php">AD SERVICE ACCOUNT DELETION</a>
                </li>
            </ul>
     </div>
</div>
		...
		<div class="col-md-9">
			...
			<br>
			<form action="fileup2.php" method="post" enctype="multipart/form-data"> 
			<h5> Please upload the input csv file</h5>
			<input type="file" name="file" id="file" required>
			<!--input type="file" id="input" required-->
			<h5>mandate columns dns_HostName,domainname,dns_HostIP</h5>
			<br>
			</center>
			<?php
			$date=date('d_m_Y_h_i');
