...
<div class="login-container">
    ...
    <i class="fa fa-bars fa-2x toggle-btn" data-toggle="collapse" data-target="#menu-content"></i>
        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content collapse out">
                ...
                <li  data-toggle="collapse" data-target="#products" class="collapsed active">
                  <a href="dash1.php">AD USERS AND COMPUTER DELETION</a>
                </li>
		...
		<div class="col-md-9">
			<center>
			<h3><b>AD DECOMMISSION</b></h3>
			<br>
			<form action="fileup.php" method="post" enctype="multipart/form-data"> 
			<h5> Please upload the input csv file</h5>
			<input type="file" name="file" id="file" required>
			<!--input type="file" id="input" required-->
			<h5>mandate columns servername,domainname</h5>
			<a href="http:\\localhost:80\server_decomm\server_cleanup_common_input.csv" download>download sample input file</a>
			<br>
			</center>
			<?php
			$date=date('d_m_Y_h_i');
			$file="ad_status_log_".$date.".html";
			$username=$_SESSION["username"];
			$password=$_SESSION["res"];
