...
<div class="login-container">
    ...
    <i class="fa fa-bars fa-2x toggle-btn" data-toggle="collapse" data-target="#menu-content"></i>
        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content collapse out">
                ...
                <li data-toggle="collapse" data-target="#new" class="collapsed">
                 ...
                 <li data-toggle="collapse" data-target="#new" class="collapsed">
                  <a href="dash4.php">VM DELETION</a>
                  </li>
				...
				<li data-toggle="collapse" data-target="#new" class="collapsed active">
                  <a href="dash11.php">BIGFIX SERVER DECOMMISSION</a>
                </li>
				<li data-toggle="collapse" data-target="#new" class="collapsed">
		...
		<div class="col-md-9">
			<center>
			<h3><b>Big Fix Server Decommission</h3>
			<br>
			<form action="fileup11.php" method="post" enctype="multipart/form-data"> 
			<h5> Please upload the input csv file</h5>
			<input type="file" name="file" id="file" required>
			<!--input type="file" id="input" required-->
			<h5>mandate columns bigfixserver</h5>
			<br>
			</center>
			<?php
			$date=date('d_m_Y_h_i');
			$file="bigfix_deletion_log_".$date.".html";
			$res=$_SESSION["res"];
			?>
			<input type="hidden" name="file1" value='<?php echo "$file"; ?>'>
			<input type="hidden" name="file2" value='<?php echo "$res"; ?>'>
