...
<div class="login-container">
    ...
    <i class="fa fa-bars fa-2x toggle-btn" data-toggle="collapse" data-target="#menu-content"></i>
		...
		<div class="col-md-9">
			...
			<form action="fileup5.php" method="post" enctype="multipart/form-data" > 
			<h5> Please upload the input csv file</h5>
			<input type="file" name="file" id="file" required>
			<!--input type="file" id="input" required-->
			<h5>mandate columns serverip</h5>
			<br>
			</center>
			<?php
			$date=date('d_m_Y_h_i');
			$file="IPAM_log_".$date.".html";
			$username=$_SESSION["username"];
			...
			<input type="hidden" name="file3" value='<?php echo "$sfcase"; ?>'>
			<input type="hidden" name="file4" value='<?php echo "$res"; ?>'>
			<center><input type="submit" id="submit" name="execute" value="PRECHECK" onClick="hello1()">  <input type="button" name="exit" onClick="window.location.href=window.location.href" value=" CANCEL"></center>
			<hr/>
			</form>
