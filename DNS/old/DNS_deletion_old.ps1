...
Start-Transcript -Path "$path\Report1_$date.txt"
...
$GetProcessJob = Start-Job -Credential $Credential -ArgumentList "$filepath,$destinationfile,$sfcase,$username,$password" -FilePath C:\xampp\htdocs\server_decomm\DNS\base.ps1
...
#-FilePath C:\xampp\htdocs\server_decomm\DNS\base.ps1 -ArgumentList "$filepath,$destinationfile,$sfcase,$username,$password" -Credential $Credential
...
<#Invoke-Command -ComputerName localhost -Credential $Credential -ArgumentList $filepath,$destinationfile,$sfcase,$username,$password -ScriptBlock{
$filepath=$args[0]
...
$ProcessInfo.Arguments = "& C:\xampp\htdocs\server_decomm\DNS\base.ps1 $filepath,$destinationfile,$sfcase,$username,$password"
...
#$args = "C:\xampp\htdocs\server_decomm\DNS\base.ps1"
#Start-Process powershell.exe -Credential $Cred -Verb RunAs -ArgumentList  '-executionpolicy bypass', '-file',$args
