...
<div class="login-container">
    ...
    <i class="fa fa-bars fa-2x toggle-btn" data-toggle="collapse" data-target="#menu-content"></i>
        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content collapse out">
                ...
                <li data-toggle="collapse" data-target="#service" class="collapsed active">
                  <a href="dash2.php"> DNS DELETION </a>
                </li>  
		...
		<div class="col-md-9">
			...
			<center>
			<div id="hello123"></div>
			<h3><b>DNS DELETION</b></h3>
			<br>
			<form action="fileup2.php" method="post" id="test" enctype="multipart/form-data">

				<h5> Please upload the input csv file</h5>
				<input type="file" name="file" id="file" required>
				<!--input type="file" id="input" required-->
				<h5>mandate columns servername,serverip,dnsservername,domainname</h5>
				<br>
				</center>
								
				<?php
				$date=date('d_m_Y_h_i');
				$file="dns_status_log_".$date.".html";
				...
				<input type="hidden" name="file2" value='<?php echo "$username"; ?>'>
				<input type="hidden" name="file3" value='<?php echo "$password"; ?>'>
				<input type="hidden" name="file4" value='<?php echo "$sfcase"; ?>'>
			...
			<input type="hidden" name="file6" value='<?php echo "$sfcase"; ?>'>
			<center><input type="button" id="submit1" name="execute1" value="EXECUTION STATUS" style="display:none"></center>
			</form>
		</div>
	</div>
</div>
...
//	console.log("hello");
//	var file1='<?php echo $file; ?>';
//	var file2='<?php echo $username; ?>';
//	var file3='<?php echo $password ?>';
//	var file4='<?php echo $sfcase ?>';
//	//alert(this);
...
//function hello123(){
        e.preventDefault();
		//console.log("hai");
		var file6='<?php echo $sfcase; ?>';
		var file7='<?php echo $file; ?>';
		$.ajax({
		url:"fileup3.php",
		method:"post",
		data: {
