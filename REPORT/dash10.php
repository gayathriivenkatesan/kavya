...
<div class="login-container">
    ...
    <i class="fa fa-bars fa-2x toggle-btn" data-toggle="collapse" data-target="#menu-content"></i>
        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content collapse out">
				...
				<li data-toggle="collapse" data-target="#new" class="collapsed active">
                  <a href="dash10.php">OVERALL REPORT</a>
                </li>
				<li data-toggle="collapse" data-target="#new" class="collapsed">
		...
		<div class="col-md-9">
			<center>
			<h3><b>OVERALL REPORT</b></h3>

	 
		<div id="hello" style="display:None;width:90%;"></div>
		<div id="hello1">
		<center><h4> LIST OF SFCASES</h4></center>		
		  <table id="example" class= "table table-light table-sm" width="90%">
		    <thead>
			  <tr>
				<th>Select</th>
				<th>SFcase</th>
		  ...
		  <?php
			foreach($files1 as $values){
				if($values != '.'){
				   ...
				   <td style="background-color:white;"><?php print_r($values); ?></td>
				   </tr>
