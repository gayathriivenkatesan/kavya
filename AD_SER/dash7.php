...
<div class="login-container">
    ...
    <i class="fa fa-bars fa-2x toggle-btn" data-toggle="collapse" data-target="#menu-content"></i>
        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content collapse out">
			    ...
			    <li data-toggle="collapse" data-target="#new"  class="collapsed active">
                  <a href="dash7.php">AD SERVICE ACCOUNT DELETION</a>
                </li>
				<li data-toggle="collapse" data-target="#new" class="collapsed">
		...
		<div class="col-md-9">
			<center>
			<h3><b>SERVICE ACCOUNT AD DECOMMISSION</b></h3>
			<br>
			<form action="fileup.php" method="post" enctype="multipart/form-data"> 
			<h5> Please upload the input csv file</h5>
			<input type="file" name="file" id="file" required>
			<!--input type="file" id="input" required-->
			<h5>mandate columns user_security_group</h5>
			<br>
			</center>
			<?php
			$date=date('d_m_Y_h_i');
			$file="serviceaccount_ad_status_log_".$date.".html";
			$_SESSION["file"]=$file;
			$res=$_SESSION["res"];
			?>
